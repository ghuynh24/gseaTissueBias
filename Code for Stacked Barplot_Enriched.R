...
############### GH Edited 3/26 #################
################################################
filename<-load("~/ISB/Figures/Results_Enriched_mastertable.RData")
...
#--------------------------------------------------------
RE1<-Results_Enriched[order(-Results_Enriched$N_Enriched),]
RE2<-(RE1[-c(18:37),])
...
title(xlab="Tissue", line=6.5, cex.lab=1)
title(main="Fraction Coverage per Enriched Tissue", line=1, cex.main=1)
